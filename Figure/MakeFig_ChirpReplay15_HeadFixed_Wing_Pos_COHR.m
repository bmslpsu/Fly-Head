function [] = MakeFig_ChirpReplay15_HeadFixed_Wing_Pos_COHR(root,figNum)
%% MakeFig_ChirpReplay15_HeadFixed_Wing_Pos_COHR:
%   INPUTS:
...
% figNum = 1;
%---------------------------------------------------------------------------------------------------------------------------------
filename = 'ChirpReplay15_HeadFixed_Wing_Pos_COHR'; % name of figure to save
