function [] = MakeFig_ChirpReplay15_HeadFixed_Wing_Pos_Time(root,figNum)
%% MakeFig_ChirpReplay15_HeadFixed_Wing_Pos_Time:
%   INPUTS:
...
%---------------------------------------------------------------------------------------------------------------------------------
% EXAMPLE INPUT %
root = 'H:\Experiment_HeadExcitation\ChirpReplay_15\DATA\';
figNum = 1;
%---------------------------------------------------------------------------------------------------------------------------------
filename = 'ChirpReplay15_HeadFixed_Wing_Pos_Time'; % name of figure to save
HeadFixed = load([root 'ChirpReplay15_HeadFixed_DATA.mat'],'PAT','WING','n','unq'); % load data structure
