function [] = MakeFig_Sine_HeadFree_WingvsPat_Pos_Time(amp,root,figNum)
%% MakeFig_Sine_HeadFree_WingvsPat_Pos_Time: time domain sinusoid plot for all amplitudes & frequencies
%   INPUTS:
...
% amp = 1:5;
%---------------------------------------------------------------------------------------------------------------------------------
filename = 'Sine_HeadFree_WingvsPat_Pos_Time'; % name of figure to save
