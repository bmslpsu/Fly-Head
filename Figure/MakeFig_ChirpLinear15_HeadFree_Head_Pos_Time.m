function [] = MakeFig_ChirpLinear15_HeadFree_Head_Pos_Time(root,figNum)
%% MakeFig_ChirpLinear15_HeadFree_Head_Pos_Time:
%   INPUTS:
...
figNum = 1;
%---------------------------------------------------------------------------------------------------------------------------------
filename = 'ChirpLinear15_HeadFree_Head_Pos_Time'; % name of figure to save
