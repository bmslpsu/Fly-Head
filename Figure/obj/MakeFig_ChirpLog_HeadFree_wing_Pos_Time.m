function [FIG] = MakeFig_ChirpLog_HeadFree_wing_Pos_Time()
%% MakeFig_ChirpLog_HeadFree_wing_Pos_Time.m:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
filename = 'ChirpLog_HeadFree_wing_Pos_Time'; % name of figure to save
...
pp = 1;
for jj = 1:HeadFree.N{1,3}
    ax = subplot(HeadFree.N{1,3},1,pp) ; hold on ; xlim([0 20]) ; ylim(3*[-1 1])
