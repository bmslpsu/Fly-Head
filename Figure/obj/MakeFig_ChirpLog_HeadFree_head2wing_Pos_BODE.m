function [FIG] = MakeFig_ChirpLog_HeadFree_head2wing_Pos_BODE()
%% MakeFig_ChirpLog_HeadFree_head2wing_Pos_BODE:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
filename = 'ChirpLog_HeadFree_head2wing_Pos_BODE'; % name of figure to save
...
%             subplot(2,HeadFree.N{1,3},pp) ; hold on ; xlim([0 12]) ; ylim([0 2])
