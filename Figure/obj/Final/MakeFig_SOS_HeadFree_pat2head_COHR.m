...
PlotPatch(HeadFree.GRAND{pat2head}.Mean{1}{7}(:,xIdx), HeadFree.GRAND{pat2head}.STD{1}{7}(:,xIdx),...
    HeadFree.GRAND{pat2head}.Mean{1}{8}(:,xIdx), 1, HeadFree.N{1,1}, 'k', [0.4 0.4 0.6], 0.5, 1);

[~,h.wing] = PlotPatch(HeadFree.GRAND{pat2wing}.Mean{1}{7}(:,xIdx), HeadFree.GRAND{pat2wing}.STD{1}{7}(:,xIdx),...
    HeadFree.GRAND{pat2wing}.Mean{1}{8}(:,xIdx), 1, HeadFree.N{1,1}, 'g', [0.4 0.4 0.6], 0.5, 1);

[~,h.wing_fixed] = PlotPatch(HeadFixed.GRAND{fixedwing}.Mean{1}{7}(:,xIdx), HeadFixed.GRAND{fixedwing}.STD{1}{7}(:,xIdx),...
    HeadFixed.GRAND{fixedwing}.Mean{1}{8}(:,xIdx), 1, HeadFixed.N{1,1}, 'r', [0.4 0.4 0.6], 0.5, 1);

[~,h.headwing] = PlotPatch(HeadFree.GRAND{head2wing}.Mean{1}{7}(:,xIdx), HeadFree.GRAND{head2wing}.STD{1}{7}(:,xIdx),...
    HeadFree.GRAND{head2wing}.Mean{1}{8}(:,xIdx), 1, HeadFree.N{1,1}, 'b', [0.4 0.4 0.6], 0.5, 1);

[~,h.errwing] = PlotPatch(HeadFree.GRAND{err2wing}.Mean{1}{7}(:,xIdx), HeadFree.GRAND{err2wing}.STD{1}{7}(:,xIdx),...
    HeadFree.GRAND{err2wing}.Mean{1}{8}(:,xIdx), 1, HeadFree.N{1,1}, 'm', [0.4 0.4 0.6], 0.5, 1);

uistack(h.wing,'top')
uistack(h.errwing,'top')
uistack(h.wing_fixed,'top')

errorbar(HeadFree.GRAND{pat2head}.Mean{1}{4}(:,xIdx),HeadFree.GRAND{pat2head}.Mean{1}{9}(:,xIdx),...
    1*HeadFree.GRAND{pat2head}.STD{1}{9}(:,xIdx)./sqrt(HeadFree.N{1,1}),'-k','LineWidth',2)

errorbar(HeadFree.GRAND{pat2wing}.Mean{1}{4}(:,xIdx),HeadFree.GRAND{pat2wing}.Mean{1}{9}(:,xIdx),...
    1*HeadFree.GRAND{pat2wing}.STD{1}{9}(:,xIdx)./sqrt(HeadFree.N{1,1}),'-g','LineWidth',2)

errorbar(HeadFixed.GRAND{fixedwing}.Mean{1}{4}(:,xIdx),HeadFixed.GRAND{fixedwing}.Mean{1}{9}(:,xIdx),...
    1*HeadFixed.GRAND{fixedwing}.STD{1}{9}(:,xIdx)./sqrt(HeadFixed.N{1,1}),'Color','r','LineWidth',2)

errorbar(HeadFree.GRAND{head2wing}.Mean{1}{4}(:,xIdx),HeadFree.GRAND{head2wing}.Mean{1}{9}(:,xIdx),...
    1*HeadFree.GRAND{head2wing}.STD{1}{9}(:,xIdx)./sqrt(HeadFree.N{1,1}), 'Color', 'b', 'LineWidth',2)

errorbar(HeadFree.GRAND{err2wing}.Mean{1}{4}(:,xIdx),HeadFree.GRAND{err2wing}.Mean{1}{9}(:,xIdx),...
    1*HeadFree.GRAND{err2wing}.STD{1}{9}(:,xIdx)./sqrt(HeadFree.N{1,1}), 'Color', 'm', 'LineWidth',2)
