function [FIG] = MakeFig_SOS_HeadFixed_Replay_pat2wing_BODE()
%% MakeFig_SOS_HeadFixed_Replay_pat2wing_BODE:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
ax2 = subplot(2,1,2) ; hold on
    ...
    GAIN = rad2deg(HeadFixed.GRAND{1,catIdx}.CircMean{7}{6}(:,xIdx));
    GAIN(GAIN>60) = GAIN(GAIN>60) - 360;
    
    errorbar(HeadFixed.GRAND{1,catIdx}.Mean{2}{4},GAIN,...
        rad2deg(2*HeadFixed.GRAND{1,catIdx}.CircSTD{7}{6}(:,xIdx)),'-oc','LineWidth',3);
