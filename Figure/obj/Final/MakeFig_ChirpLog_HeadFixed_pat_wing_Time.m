function [FIG] = MakeFig_ChirpLog_HeadFixed_pat_wing_Time()
%% MakeFig_ChirpLog_HeadFixed_pat_wing_Time:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
clearvars -except HeadFixed Amp nAmp
%%
figNum = 1;
catIdx = 2;
xIdx = 1;
...
pp = 1;
for jj = 3
    ax.R = subplot(1,1,pp) ; hold on ; title([num2str(HeadFixed.U{1,3}{1}(jj)) char(176)],'FontSize',15)
    ax.R.YColor = [0 1 0];
