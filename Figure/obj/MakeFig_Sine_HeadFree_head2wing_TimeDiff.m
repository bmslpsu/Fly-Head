function [FIG] = MakeFig_Sine_HeadFree_head2wing_TimeDiff()
%% MakeFig_Sine_HeadFree_head2wing_TimeDiff:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
for ww = 1:nAmp % amplitudes
    ...
    hh{ww} = h.Fly;
    plot([0 12],[0 0],'--k')
    ylabel('Head to Wing Time Difference (s)','interpreter','latex','FontSize',15)
