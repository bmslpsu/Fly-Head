function [FIG] = MakeFig_ChirpLog_HeadFree_pat2wing_Pos_COHR()
%% MakeFig_ChirpLog_HeadFree_pat2wing_Pos_COHR:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
filename = 'ChirpLog_HeadFree_pat2wing_Pos_COHR'; % name of figure to save
