function [FIG] = MakeFig_ChirpLog_HeadFree_pat2head_Pos_BODE_ALL()
%% MakeFig_ChirpLog_HeadFree_pat2head_Pos_BODE_ALL:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
filename = 'ChirpLog_HeadFree_pat2head_Pos_BODE_ALL'; % name of figure to save
...
for jj = 1:HeadFree.N{1,3}
    ax = subplot(2,1,1) ; hold on ; xlim([0.1 12]) ; ylim([0 1.2])
