function [FIG] = MakeFig_Sine_HeadFree_pat2head_TimeDiff()
%% MakeFig_Sine_HeadFree_pat2head_TimeDiff:
%   INPUTS:
%       -
%   OUTPUTS:
%       FIG     :   figure handle
...
figNum = 1;
filename = 'Sine_HeadFree_pat2head_TimeDiff'; % name of figure to save
catIdx = 5; % pat2head
xIdx = 1;
...
for ww = 1:nAmp % amplitudes
    ...
    hh{ww} = h.Fly;
    plot([0 12],[0 0],'--k')
    ylabel('Pat to Head Time Difference (s)','interpreter','latex','FontSize',15)
