function [] = MakeFig_SOS_HeadFree_head2wing_CrossCorr()
%% MakeFig_SOS_HeadFree_head2wing_CrossCorr:
%   INPUTS:
%       -
%   OUTPUTS:
%       -
...
for ww = 1:nAmp % amplitudes 
    ...
    for jj = 1:HeadFree{ww}.N{1,3} % frequencies
        ...
        PlotPatch(CC ,CC_STD, TL, 2, HeadFree{ww}.N{1,1}, 'b', [0.4 0.4 0.6], 0.5, 2);
