function [] = MakeFig_ChirpReplay15_HeadFixed_Wing_Pos_BODE(root,figNum)
%% MakeFig_ChirpReplay15_HeadFixed_Wing_Pos_BODE:
%   INPUTS:
...
figNum = 1;
%---------------------------------------------------------------------------------------------------------------------------------
filename = 'ChirpReplay15_HeadFixed_Wing_Pos_BODE'; % name of figure to save
