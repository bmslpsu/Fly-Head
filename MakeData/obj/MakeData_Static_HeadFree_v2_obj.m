function [] = MakeData_Static_HeadFree_v2_obj(rootdir)
%% MakeData_Static_HeadFree_v2_obj: Reads in all raw trials, transforms data, and saves in organized structure for use with figure functions
%   INPUTS:
%       root        : root directory
%   OUTPUTS:
%       -
...
for kk = 1:N.file
    ...
    Head = Fly(head.Pos,head.Time,30,IOFreq); % head object
  	%-----------------------------------------------------------------------------------------------------------------------------
