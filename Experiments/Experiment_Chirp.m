function [] = Experiment_HeadExcitation_Chirp_V2(Fn)
...
% root = ['C:\BC\Rigid_data\Experiment_HeadExcitation\Chirp\ALL\'];
% root = ['C:\BC\Rigid_data\Experiment_HeadExcitation\Chirp\HeadFixed\'];
% root = ['C:\BC\Rigid_data\Experiment_HeadExcitation\Chirp\Walking\'];
root = 'E:\Experiment_HeadExcitation\Chirp\Walking\';
...
for ii =  1:n_Amp*n_rep    
	...
	Panel_com('set_funcX_freq', 100); pause(n_pause)                % 100Hz update rate for x-channel
