...
dirPat = 'C:\Users\boc5244\Documents\GitHub\Arena\Patterns';

% Open pattern file
[file, dirPat] = uigetfile({'*.mat', 'MAT-files'}, ...
    'Select pattern file', dirPat, 'MultiSelect','off');

% open file
patfile = fullfile(dirPat,file);
