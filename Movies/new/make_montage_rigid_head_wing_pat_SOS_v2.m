function [MOV] = make_montage_rigid_head_wing_pat_SOS_v2(rootdir,rootpat,vidFs,export)
%% make_montage_rigid_head_wing_pat_SOS_v2: makes movie for fly in rigid tether
%
