function [MOV] = make_montage_rigid_head_wing_pat_SOS_v2_head_fixed(rootdir,rootpat,vidFs,export)
%% make_montage_rigid_head_wing_pat_SOS_v2_head_fixed: makes movie for fly in rigid tether
%
...
FLY.head    = 0*FLY.wba; % head angles [deg]
...
FLY.head_length = 41;
FLY.head_hinge = [params.gui.head.hinge.x  , -3 + params.gui.head.hinge.y];
