function [MOV] = make_montage_rigid_head_wing_pat_SS(rootdir,rootpat,vidFs,export)
%% make_montage_rigid_head_wing_pat_SS: makes movie for fly in rigid tether
%
...
export = false;
vidFs = 50;
rootdir = 'H:\EXPERIMENTS\RIGID\Experiment_Sinusoid\15';
...
set(ax(end),'XTick', 0:1:round(FLY.time(end)))
