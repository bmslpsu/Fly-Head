function [MOV] = BeniflyMontage_Chirp(rootdir,rootpat,vidFs,export)
%% BeniflyMontage_Chirp:  makes movie for fly in rigid tether
...
for jj = 1:iter:n_frame % for each frame 
    ...
    set(ax(3), 'YLim', [-35 35], 'YTick', [-30 0 30])
    set(ax(1:2), 'XTick', [])
