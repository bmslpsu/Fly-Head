function [MOV] = BeniflyMontage_Ramp(rootdir,rootpat,vidFs,export)
%% BeniflyMontage_Ramp:  makes movie for fly in rigid tether
...
for jj = 1:n_frame % for each frame
    ...
    set(ax(1), 'YLim', [0 360], 'YTick', [0:90:360])
    set(ax(2), 'YLim', 20*[-1 1], 'YTick', [-15 0 15])
    set(ax(3), 'YLim', 35*[-1 1], 'YTick', [-25 0 25])
    set(ax(1:2), 'XTick', [])
